# -*- coding: utf-8 -*-
"""Tiny_Music_Transformer_Maker.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13B36UWxRlrFg3LNZAwrJ6_Uf7VGMyi1_

# Tiny Music Transformer Maker (ver. 1.0)
...
def TMIDIX_MIDI_Processor(midi_file):
    ...
    try:
        ...
        if file_size <= 1000000:
          ...
          # Convering MIDI to ehanced ms score with TMIDIX advanced score processor
...
#x = torch.tensor([[642, 512+1, 72+514]] * 1, dtype=torch.long, device='cuda')
#x = torch.tensor([[642]] * 1, dtype=torch.long, device='cuda')
...
train_data1 = y[0] # y[0]batch number goes here
